    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 select-none">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-800">Что добавить?</h3>
          <div className="group relative">
            <span className="text-gray-400 hover:text-indigo-500 cursor-help text-lg select-none">ⓘ</span>
            <div className="absolute bottom-full right-0 mb-2 w-60 bg-gray-800 text-white text-xs rounded-lg p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 shadow-xl pointer-events-none">
              ...
              <div className="absolute top-full right-2 -mt-1 w-2 h-2 bg-gray-800 rotate-45" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {options.map((opt) => (
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition text-left"
            >
        ...
        <button
          onClick={onClose}
          className="w-full mt-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition select-none"
        >
          Отмена
        </button>
      </div>
